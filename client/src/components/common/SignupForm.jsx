...
const SignupForm = ({ switchAuthState }) => {
  ...
  const signinForm = useFormik({
    ...
    validationSchema: Yup.object({
      username: Yup.string()
        .min(8, "username should have minimum 8 characters")
        .required("username is required"),
      password: Yup.string()
        .min(8, "password should have minimum 8 characters")
        .required("password is required"),
      displayName: Yup.string()
        .min(8, "displayName should have minimum 8 characters")
        .required("displayName is required"),
      confirmPassword: Yup.string()
        .oneOf([Yup.ref("password")], "confirmPassword not matched")
        .min(8, "confirmPassword should have minimum 8 characters")
